...
/// The source is any source of UTF-8 bytes, such as a file or string.
pub fn currency_from_json(source: &mut Read) -> Result<RcCurrency, qm::Error> {
...
pub fn pricer_factory_from_json(source: &mut Read) -> Result<RcPricerFactory, qm::Error> {
...
/// day.
pub fn fixing_table_from_json(source: &mut Read) -> Result<RcFixingTable, qm::Error> {
    // create a deserializer based on the input and use it to deserialize the pricer factory
    let mut deserializer = sdj::Deserializer::from_reader(source);
...
pub fn market_data_from_json(source: &mut Read) -> Result<RcMarketData, qm::Error> {
    // create a deserializer based on the input and use it to deserialize the pricer factory
    let mut deserializer = sdj::Deserializer::from_reader(source);
...
pub fn report_generator_from_json(source: &mut Read) -> Result<RcReportGenerator, qm::Error> {
    // create a deserializer based on the input and use it to deserialize the pricer factory
    let mut deserializer = sdj::Deserializer::from_reader(source);
...
/// or distribution.
pub fn reports_from_json(source: &mut Read) -> Result<Vec<BoxReport>, qm::Error> {
    // create a deserializer based on the input and use it to deserialize the pricer factory
    let mut deserializer = sdj::Deserializer::from_reader(source);
